    ...
    <header className="fixed top-0 left-0 right-0 z-40 h-10 bg-gradient-to-r from-[#0b1320] via-[#111e33] to-[#1a2d4b] text-white flex items-center justify-between px-3 select-none text-xs font-normal shadow-sm">
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <div className="relative">
          ...
          {showCreateMenu && (
            <div
              className="absolute left-0 mt-1 w-44 bg-[#0d1624] border border-black/30 rounded-sm shadow-xl py-1 z-50"
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          ...
          {showUserMenu && (
            <div
              className="absolute right-0 mt-1 w-48 bg-[#0d1624] border border-black/30 rounded-sm shadow-xl py-1 z-50"
            ...
            >
              ...
              <button
                ...
                className="w-full text-left flex items-center gap-2 px-3 py-2 text-xs text-red-400 hover:bg-red-950/30 hover:text-red-300 font-normal border-t border-black/20"
              >
