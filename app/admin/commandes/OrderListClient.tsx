                  ...
                  filteredOrders.map((ord) => (
                    <tr key={ord.id} className="hover:bg-[#f0f6fc]/50 transition-colors group font-normal">
                      <td className="p-3 font-mono">
                        ...
                        <div className="flex items-center gap-2 text-xs font-medium mt-1 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity font-sans">
                          <Link
                            href={`/admin/commandes/${ord.id}`}
