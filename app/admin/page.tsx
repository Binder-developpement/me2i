  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-[#c3c4c7] pb-4">
        <div>
          <h1 className="text-2xl font-bold text-[#1d2327]">Tableau de bord</h1>
        ...
        <div className="flex items-center gap-2">
          <Link
            ...
            className="inline-flex items-center gap-1.5 bg-[#2271b1] hover:bg-[#135e96] text-white text-xs font-semibold px-3 py-2 rounded-sm transition-colors shadow-sm"
          >
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 bg-[#1E3A5F] hover:bg-[#152943] text-white text-xs font-semibold px-3 py-2 rounded-sm transition-colors shadow-sm"
          >
            <Plus className="h-3.5 w-3.5" />
      ...
      <div className="bg-white border border-[#c3c4c7] rounded-sm p-6 shadow-sm relative overflow-hidden">
        <div className="max-w-3xl">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-4 text-xs font-semibold text-[#2271b1]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        {/* Articles */}
        <div className="bg-white border border-[#c3c4c7] rounded-sm p-4 shadow-sm flex flex-col justify-between hover:border-[#2271b1] transition-colors group">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-[#646970] uppercase tracking-wider">
              Articles
            </span>
            <div className="p-2 rounded bg-blue-50 text-[#2271b1]">
              <FileText className="h-4 w-4" />
            </div>
          </div>
          <div className="mt-3">
            <span className="text-2xl font-bold text-[#1d2327]">{stats.articles}</span>
          </div>
          <Link
            href="/admin/articles"
            className="mt-3 text-xs text-[#2271b1] font-semibold flex items-center gap-1 group-hover:underline"
          >
        ...
        <div className="bg-white border border-[#c3c4c7] rounded-sm p-4 shadow-sm flex flex-col justify-between hover:border-[#2271b1] transition-colors group">
          ...
          <div className="mt-3">
            <span className="text-2xl font-bold text-[#1d2327]">{stats.services}</span>
          </div>
          <Link
            href="/admin/services"
            className="mt-3 text-xs text-[#2271b1] font-semibold flex items-center gap-1 group-hover:underline"
        ...
        <div className="bg-white border border-[#c3c4c7] rounded-sm p-4 shadow-sm flex flex-col justify-between hover:border-[#2271b1] transition-colors group">
          ...
          <div className="mt-3">
            <span className="text-2xl font-bold text-[#1d2327]">{stats.products}</span>
          </div>
          <Link
            href="/admin/produits"
            className="mt-3 text-xs text-[#2271b1] font-semibold flex items-center gap-1 group-hover:underline"
        ...
        <div className="bg-white border border-[#c3c4c7] rounded-sm p-4 shadow-sm flex flex-col justify-between hover:border-[#2271b1] transition-colors group">
          ...
          <div className="mt-3">
            <span className="text-2xl font-bold text-[#1d2327]">{stats.orders}</span>
          </div>
          <Link
        ...
        <div className="bg-white border border-[#c3c4c7] rounded-sm p-4 shadow-sm flex flex-col justify-between hover:border-[#2271b1] transition-colors group">
          ...
          <div className="mt-3">
            <span className="text-2xl font-bold text-[#1d2327]">{stats.contacts}</span>
          </div>
          <Link
            href="/admin/contacts"
            className="mt-3 text-xs text-[#2271b1] font-semibold flex items-center gap-1 group-hover:underline"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-[#c3c4c7] rounded-sm shadow-sm">
          <div className="px-4 py-3 border-b border-[#c3c4c7] bg-[#f6f7f7] flex items-center justify-between">
            <h3 className="text-xs font-bold uppercase tracking-wider text-[#1d2327] flex items-center gap-2">
          ...
          <div className="divide-y divide-[#f0f0f1]">
            {recentContacts.length === 0 ? (
              <div className="p-6 text-center text-xs text-[#646970]">
                Aucun message reçu pour le moment.
              </div>
            ) : (
              recentContacts.map((contact) => (
                <div key={contact.id} className="p-3.5 hover:bg-[#f6f7f7] transition-colors flex items-center justify-between">
                  <div>
                    <p className="text-xs font-bold text-[#1d2327]">{contact.name}</p>
                    <p className="text-[11px] text-[#646970] truncate max-w-xs">{contact.subject || contact.email}</p>
                  </div>
                  <div className="text-right">
                    ...
                    <p className="text-[10px] text-[#a7aaad] mt-0.5">
          ...
          <div className="divide-y divide-[#f0f0f1]">
            {recentArticles.length === 0 ? (
              ...
              recentArticles.map((art) => (
                <div key={art.id} className="p-3.5 hover:bg-[#f6f7f7] transition-colors flex items-center justify-between">
                  <span className="text-xs font-semibold text-[#1d2327] truncate max-w-sm">
                    {art.title}
                  </span>
