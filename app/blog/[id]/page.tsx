  ...
  return (
    <div className="pt-24 pb-20 min-h-screen bg-[#f8fafc] text-gray-800">
      ...
      <div className="bg-white border-b border-gray-200 py-3 mb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between text-xs text-gray-500 font-normal">
          ...
          <Link
            href="/blog"
            className="inline-flex items-center gap-1 text-[#1E3A5F] hover:underline shrink-0"
          >
